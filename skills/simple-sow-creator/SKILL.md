...
Use these approved SOWs to ground style, tone, and formatting:

- `SOW09 - Partners Life - Shared APIM` - Example SOW for API management project
- `SOW12 - Partners Life - Certificate Investigation and Remediation Plan` - Example SOW for certificate work
- `SOW14 - CrowdStrike Logging Connector` - Example SOW for logging/connector implementation
